...
const Header = () => {
  return (
    <div className='w-11/12 max-w-3xl text-center m-auto h-screen flex flex-col items-center justify-center gap-4'>
      <div>
      ...
      <h3 className='flex items-end gap-2 text-xl md:text-2xl mb-3 font-ovo'>Hi, I'm Glory Opeoluwa <Image src={assets.hand_icon} alt=''
        ...
        <a href="/glory.pdf" 
        download="glory.pdf" className='px-10 py-3 border rounded-full border-gray-50 flex items-center gap-2'>My resume <Image src={assets.download_icon} alt=''
        className='w-4' /></a>
        </div>
    </div>
  )
